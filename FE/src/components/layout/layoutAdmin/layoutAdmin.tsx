  ...
  <div className="fixed top-0 left-0 w-1/6 h-full bg-gray-800 text-white flex flex-col">
    <div className="p-6 flex flex-col items-center">
      ...
      <ul className="space-y-4 w-full">
        ...
        <li>
          <Link className="flex items-center text-white hover:text-gray-300" to="/admin/color">
            <IoColorPaletteOutline className="mr-2" />
            Danh mục màu sắc
          </Link>
        </li>
        <li>
          <Link className="flex items-center text-white hover:text-gray-300" to="/admin/size">
