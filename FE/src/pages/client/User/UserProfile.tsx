      ...
      <aside className="sidebar w-full md:w-1/3 lg:w-1/4 bg-white shadow-lg rounded-xl p-6">
        ...
        <nav className="menu space-y-4 text-muted">
          ...
          {isProfileDropdownOpen && (
            <div className="ml-4 mt-2 space-y-2">
              <Link
                ...
                className={`block py-2 px-4 rounded-xl transition-all duration-300 transform hover:bg-orange-100 hover:text-orange-500 ${activeDropdownItem === "userinfo" ? "bg-orange-500 text-white" : "bg-gray-100"}`}
              >
                Thông Tin
              </Link>
              <Link
                ...
                className={`block py-2 px-4 rounded-xl transition-all duration-300 transform hover:bg-orange-100 hover:text-orange-500 ${activeDropdownItem === "address" ? "bg-orange-500 text-white" : "bg-gray-100"}`}
              >
                Địa Chỉ
              </Link>
              <Link
                ...
                className={`block py-2 px-4 rounded-xl transition-all duration-300 transform hover:bg-orange-100 hover:text-orange-500 ${activeDropdownItem === "change-password" ? "bg-orange-500 text-white" : "bg-gray-100"}`}
              >
                Đổi Mật Khẩu
              </Link>
            </div>
          ...
          <Link
            ...
            className={`block w-full text-left py-2 px-4 rounded-xl font-semibold cursor-pointer transition-all duration-300 transform hover:bg-orange-100 hover:text-orange-500 ${activeButton === "order" ? "bg-orange-500 text-white" : "bg-gray-100"}`}
          >
          ...
          <Link
            ...
            className={`block w-full text-left py-2 px-4 rounded-xl font-semibold cursor-pointer transition-all duration-300 transform hover:bg-orange-100 hover:text-orange-500 ${activeButton === "notification" ? "bg-orange-500 text-white" : "bg-gray-100"}`}
          >
          ...
          <Link
            ...
            className={`block w-full text-left py-2 px-4 rounded-xl font-semibold cursor-pointer transition-all duration-300 transform hover:bg-orange-100 hover:text-orange-500 ${activeButton === "settings" ? "bg-orange-500 text-white" : "bg-gray-100"}`}
          >
